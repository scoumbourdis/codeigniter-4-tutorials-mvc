<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.8.0.47b73d1.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.8.0.47b73d1' . $minify_or_not . '.js');
